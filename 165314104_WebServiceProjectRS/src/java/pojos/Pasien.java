package pojos;
// Generated 04-Dec-2018 17:02:12 by Hibernate Tools 4.3.1
...
public class Pasien implements java.io.Serializable {
    ...
    public String toJson() {
        return "{\"noRm\":" + getNoRm() + ",\"nama\":" + getNama() + ",\"alamat\":" + getAlamat() + ",\"nik\":" + getNik()
                + ",\"tanggalLahir\":" + getTanggalLahir() + ",\"kelamin\":" + getKelamin() + "}";
